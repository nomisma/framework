...
<!--
	...
	the structure of the SPARQL query to submit to the endpoint in order to get findspots, hoards, or a combination of both (for heatmap) pertaining to that query.
-->
<p:config xmlns:p="http://www.orbeon.com/oxf/pipeline" xmlns:oxf="http://www.orbeon.com/oxf/processors" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
	...
	<!-- evaluate the API and determine which SPARQL query to load -->
	<p:choose href="#api">
			...
			<p:processor name="oxf:unsafe-xslt">
				...
				<p:input name="config">
					<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema"
						...
						<xsl:variable name="api" select="tokenize(doc('input:request')/request/request-url, '/')[last()]"/>
