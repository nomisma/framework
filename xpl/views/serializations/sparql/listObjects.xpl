...
<!--
	Author: Ethan Gruber
	Date: June 2025
	Function: Serialize SPARQL results for related coins into HTML to be loaded via AJAX. Execute a SPARQL
...
<p:config xmlns:p="http://www.orbeon.com/oxf/pipeline" xmlns:oxf="http://www.orbeon.com/oxf/processors">
	...
	<p:processor name="oxf:url-generator">
		<p:input name="config">
			<config>
				<url>oxf:/apps/nomisma/ui/sparql/countObjects.sparql</url>
				<content-type>text/plain</content-type>
				<encoding>utf-8</encoding>
			</config>
		</p:input>
		<p:output name="data" id="countObjects-query"/>
	</p:processor>
	
	<p:processor name="oxf:text-converter">
		<p:input name="data" href="#countObjects-query"/>
		<p:input name="config">
			<config/>
		</p:input>
		<p:output name="data" id="countObjects-query-document"/>
	</p:processor>
	
	<!-- execute SPARQL query for pagination -->
	<p:processor name="oxf:unsafe-xslt">
		<p:input name="request" href="#request"/>
		<p:input name="query" href="#countObjects-query-document"/>
	...
	<p:processor name="oxf:url-generator">
		...
		<p:output name="data" id="objectCount"/>
	</p:processor>	
	...
	<p:processor name="oxf:unsafe-xslt">
		...
		<p:input name="objectCount" href="#objectCount"/>
