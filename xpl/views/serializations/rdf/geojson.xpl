...
<!--
	Author: Ethan Gruber
	Date: June 2021
	Function: Serialize Nomisma ID RDF document into GeoJSON, including SPARQL queries for mints, findspots, and hoards, if applicable. Mint and Region RDF is parsed for geographic coordinates.	
-->
