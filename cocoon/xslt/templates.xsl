...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns="http://www.w3.org/1999/xhtml"
	...
	<xsl:template name="header">
		<div class="center">
			Nomisma.org: [<a href="{$display_path}.">home</a>] [<a href="{$display_path}sparql">sparql</a>] [<a href="{$display_path}apis">apis</a>] [<a href="{$display_path}id/">all ids</a>] "Common currency for digital numismatics." 
		</div>
	</xsl:template>
