		...
		<nuds xmlns="http://nomisma.org/nuds" xmlns:xlink="http://www.w3.org/1999/xlink">
			<control>
				...
				<xsl:if test="$mode='single'">
					...
					<maintenanceAgency>
						<agencyName>American Numismatic Society</agencyName>
						<agencyCode>US-nnan</agencyCode>
					</maintenanceAgency>
					<maintenanceHistory>
						<maintenanceEvent>
							<eventType>derived</eventType>
							<eventDateTime standardDateTime="{datetime:dateTime()}"/>
							<agentType>human</agentType>
							<agent>nomisma.org</agent>
							<eventDescription>Dynamically generated from nomisma.org</eventDescription>
						</maintenanceEvent>
					</maintenanceHistory>
					<rightsStmt>
