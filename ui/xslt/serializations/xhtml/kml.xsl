...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema"
	...
	<xsl:template match="/">
		<xsl:apply-templates select="/content/xhtml:div" mode="root"/>
	</xsl:template>
				...
				<xsl:choose>
					<xsl:when test="$type='mint'">
						<Placemark xmlns="http://earth.google.com/kml/2.0">
							...
							<description>
								<![CDATA[
								<dl class="dl-horizontal"><dt>Latitude</dt><dd>]]><xsl:value-of select="descendant::*[@property='geo:lat']"/><![CDATA[</dd>
