		...
		<tr>
			...
			<td class="text-center">
				<a href="{res:binding[@name='license']/res:uri}">
					...
					<xsl:choose>
						<xsl:when test="$license = 'http://opendatacommons.org/licenses/odbl/'">ODC-ODbL</xsl:when>
						<xsl:when test="$license = 'http://opendatacommons.org/licenses/by/'">ODC-by</xsl:when>
						<xsl:when test="$license = 'http://opendatacommons.org/licenses/pddl/'">ODC-PDDL</xsl:when>
						<xsl:otherwise>
