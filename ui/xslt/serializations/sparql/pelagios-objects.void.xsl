...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:res="http://www.w3.org/2005/sparql-results#"
	...
	<xsl:template match="/">
		<rdf:RDF xmlns:skos="http://www.w3.org/2004/02/skos/core#" xmlns:nm="http://nomisma.org/id/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
			...
			<void:Dataset rdf:about="{$url}#objects">
				...
				<dcterms:description>Pleiades annotations relating to coins of Nomisma.org partners, made available through semantic reasoning between typologies, Nomisma SKOS
					concepts, and Pleiades URIs. Organizations that directly contribute to Pelagios (e.g., American Numismatic Society) are supressed from this data
					dump.</dcterms:description>
